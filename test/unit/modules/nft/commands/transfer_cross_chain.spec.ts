...
} from 'klayr-framework/dist-node/testing';
...
import * as TokenModule from 'klayr-framework/dist-node/modules/token';
import * as Token from 'klayr-framework/dist-node/modules/token/stores/user';
import { NFTModule } from '../../../../../src/app/modules/nft/module';
import {
	TransferCrossChainCommand,
	TransferCrossChainParams,
} from '../../../../../src/app/modules/nft/commands/transfer_cross_chain';
import { crossChainTransferParamsSchema } from '../../../../../src/app/modules/nft/schemas';
import {
	LENGTH_ADDRESS,
	LENGTH_CHAIN_ID,
	LENGTH_NFT_ID,
...
import { InteroperabilityMethod } from '../../../../../src/app/modules/nft/types';
...
describe('TransferCrossChainComand', () => {
	...
	const tokenMethod = new TokenModule.TokenMethod(module.stores, module.events, module.name);
	...
	let lockedExistingNFT: { nftID: Buffer; owner: Buffer };
