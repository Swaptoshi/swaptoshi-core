...
} from 'klayr-framework/dist-node/modules/token/constants';
import * as InteroperabilityModule from 'klayr-framework/dist-node/modules/interoperability';
import { InMemoryPrefixedStateDB } from 'klayr-framework/dist-node/testing';
import { CCMStatusCode } from 'klayr-framework/dist-node/modules/interoperability/constants';
...
import { CrossChainTransferCommand } from '../../../../../src/app/modules/nft/cc_commands/cc_transfer';
import { crossChainNFTTransferMessageParamsSchema } from '../../../../../src/app/modules/nft/schemas';
import { fakeLogger } from '../logger';
import { CcmTransferEvent } from '../../../../../src/app/modules/nft/events/ccm_transfer';
...
describe('CrossChain Transfer Command', () => {
	...
	const defaultEncodedCCUParams = codec.encode(InteroperabilityModule.ccuParamsSchema, {
	...
	let params: Buffer;
	let ccm: InteroperabilityModule.CCMsg;
	let command: CrossChainTransferCommand;
	let methodContext: MethodContext;
	let stateStore: PrefixedStateReadWriter;
	let context: InteroperabilityModule.CrossChainMessageContext;
