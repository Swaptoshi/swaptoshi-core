...
import { EventQueue, createMethodContext } from 'klayr-framework/dist-node/state_machine';
...
import { MethodContext } from 'klayr-framework/dist-node/state_machine/method_context';
...
import { NFTMethod } from '../../../../src/app/modules/nft/method';
import {
	InteroperabilityMethod,
	NFTAttributes,
	TokenMethod,
} from '../../../../src/app/modules/nft/types';
import {
...
import { crossChainNFTTransferMessageParamsSchema } from '../../../../src/app/modules/nft/schemas';
...
describe('InternalMethod', () => {
	...
	describe('hasDuplicateModuleNames', () => {
		it('should return false when the attributes array is empty', () => {
			...
			expect(internalMethod.hasDuplicateModuleNames(attributesArray)).toBeFalsy();
		});
	...
	describe('transferCrossChain', () => {
		...
		describe('if attributes are not included ccm contains empty attributes', () => {
			...
			it('should transfer the ownership of the NFT to the receiving chain and escrow it for a native NFT', async () => {
				...
				expect(internalMethod['_interoperabilityMethod'].send).toHaveBeenCalled();
