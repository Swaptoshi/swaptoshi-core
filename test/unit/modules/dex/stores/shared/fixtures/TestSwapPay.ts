...
import { Uint160String, Int256String, Uint256String, Uint256 } from '../../../../../../../src/app/modules/dex/stores/library/int';
...
export class TestSwapPay {
	...
	public async swap(pool: DEXPool, recipient: Buffer, zeroForOne: boolean, sqrtPriceX96: Uint160String, amountSpecified: Int256String, pay0: Uint256String, pay1: Uint256String) {
		const data = JSON.stringify({
			pool: pool.address.toString('hex'),
			pay0,
			pay1,
		});
		await pool.swap(recipient, zeroForOne, amountSpecified, sqrtPriceX96, data, this._swapCallback.bind(this));
	}
