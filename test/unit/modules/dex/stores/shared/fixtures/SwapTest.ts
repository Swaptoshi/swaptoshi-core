...
import { Int256String, Uint160String, Int256, Uint256 } from '../../../../../../../src/app/modules/dex/stores/library/int';
...
export class SwapTest {
	...
	public async getSwapResult(pool: DEXPool, zeroForOne: boolean, amountSpecified: Int256String, sqrtPriceLimitX96: Uint160String) {
		const [amount0Delta, amount1Delta] = await pool.swap(Buffer.alloc(0), zeroForOne, amountSpecified, sqrtPriceLimitX96, pool.address.toString('hex'), this._swapCallback.bind(this));
