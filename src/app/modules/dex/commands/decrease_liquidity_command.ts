...
import { decreaseLiquidityCommandSchema } from '../schema/commands/decrease_liquidity_command';
import { DecreaseLiquidityParams } from '../types';
import { verifyDecreaseLiquidityParam } from '../utils/verify';

export class DecreaseLiquidityCommand extends BaseCommand {
	// eslint-disable-next-line @typescript-eslint/require-await
	public async verify(
		_context: CommandVerifyContext<DecreaseLiquidityParams>,
