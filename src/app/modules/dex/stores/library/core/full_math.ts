...
export function mulDiv(a: Uint256String, b: Uint256String, denominator: Uint256String): Uint256String {
...
export function mulDivRoundingUp(a: Uint256String, b: Uint256String, denominator: Uint256String): Uint256String {
